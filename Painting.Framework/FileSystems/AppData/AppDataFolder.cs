...
using Painting.Framework.Localization;
using Painting.Framework.Logging;
using Painting.Framework.FileSystems.VirtualPath;
using Painting.Framework.ValidationPainting.Framework.Tools;


namespace Painting.Framework.FileSystems.AppData {
    public class AppDataFolder : IAppDataFolder {
        ...
        private void MakeDestinationFileNameAvailable(string destinationFileName) {
            ...
            try {
                ...
                throw new AppCoreException(T("Unable to make room for file \"{0}\" in \"App_Data\" folder", destinationFileName), e);
            }
        }
