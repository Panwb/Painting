...
using System.Linq;
using Painting.Framework.Environment.Extensions.Folders;
...
using Painting.Framework.Utility;
    ...
    public class ExtensionManager : IExtensionManager {
        ...
        private Feature LoadFeature(FeatureDescriptor featureDescriptor) {
            ...
            try {
                ...
                throw new AppException(T("Error while loading extension '{0}'.", extensionId), ex);
            }
